...
AnimeNode _$AnimeNodeFromJson(Map<String, dynamic> json) => AnimeNode(
      ...
      ..main_picture =
          json['main_picture'] == null ? null : MainPicture.fromJson(json['main_picture'] as Map<String, dynamic>)
      ..alternative_titles = json['alternative_titles'] == null
          ? null
          : AnimeAlternativeTitles.fromJson(json['alternative_titles'] as Map<String, dynamic>)
      ...
      ..genres = (json['genres'] as List<dynamic>?)?.map((e) => AnimeGenre.fromJson(e as Map<String, dynamic>)).toList()
      ...
      ..my_list_status = json['my_list_status'] == null
          ? null
          : UserMyListStatus.fromJson(json['my_list_status'] as Map<String, dynamic>)
      ..num_episodes = (json['num_episodes'] as num?)?.toInt()
      ..start_season =
          json['start_season'] == null ? null : AnimeSeason.fromJson(json['start_season'] as Map<String, dynamic>)
      ..broadcast =
          json['broadcast'] == null ? null : AnimeBroadcast.fromJson(json['broadcast'] as Map<String, dynamic>)
      ..source = json['source'] as String?
      ..average_episode_duration = (json['average_episode_duration'] as num?)?.toInt()
      ..rating = json['rating'] as String?
      ..studios =
          (json['studios'] as List<dynamic>?)?.map((e) => AnimeStudio.fromJson(e as Map<String, dynamic>)).toList();
...
Map<String, dynamic> _$AnimeStudioToJson(AnimeStudio instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
    };
...
Map<String, dynamic> _$AnimeGenreToJson(AnimeGenre instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
    };

AnimeBroadcast _$AnimeBroadcastFromJson(Map<String, dynamic> json) => AnimeBroadcast(
      start_time: json['start_time'] as String?,
      day_of_the_week: json['day_of_the_week'] as String,
    );

Map<String, dynamic> _$AnimeBroadcastToJson(AnimeBroadcast instance) => <String, dynamic>{
...
AnimeAlternativeTitles _$AnimeAlternativeTitlesFromJson(Map<String, dynamic> json) => AnimeAlternativeTitles(
      en: json['en'] as String?,
      ja: json['ja'] as String?,
      synonyms: (json['synonyms'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );

Map<String, dynamic> _$AnimeAlternativeTitlesToJson(AnimeAlternativeTitles instance) => <String, dynamic>{
      'en': instance.en,
      'ja': instance.ja,
