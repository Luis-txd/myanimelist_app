...
AnimeSeasonalModel _$AnimeSeasonalModelFromJson(Map<String, dynamic> json) =>
    AnimeSeasonalModel(
      data: (json['data'] as List<dynamic>)
          .map((e) => AnimeSeasonalData.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$AnimeSeasonalModelToJson(AnimeSeasonalModel instance) =>
    <String, dynamic>{
...
AnimeSeasonalData _$AnimeSeasonalDataFromJson(Map<String, dynamic> json) =>
    AnimeSeasonalData(
      node: AnimeNode.fromJson(json['node'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AnimeSeasonalDataToJson(AnimeSeasonalData instance) =>
    <String, dynamic>{
