...
AnimeRankingModel _$AnimeRankingModelFromJson(Map<String, dynamic> json) =>
    AnimeRankingModel(
      data: (json['data'] as List<dynamic>)
          .map((e) => AnimeRankingData.fromJson(e as Map<String, dynamic>))
          .toList(),
      paging: AnimePaging.fromJson(json['paging'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AnimeRankingModelToJson(AnimeRankingModel instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$AnimeRankingDataToJson(AnimeRankingData instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$AnimeRankingToJson(AnimeRanking instance) =>
    <String, dynamic>{
      'rank': instance.rank,
    };
