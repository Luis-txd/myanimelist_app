...
Map<String, dynamic> _$AnimeDetailToJson(AnimeDetail instance) => <String, dynamic>{
      ...
      'genres': instance.genres.map((Genre e) => e.toJson()).toList(),
      ...
      'pictures': instance.pictures.map((MainPicture e) => e.toJson()).toList(),
      'background': instance.background,
      'relatedAnime': instance.relatedAnime.map((RelatedAnime e) => e.toJson()).toList(),
      'relatedManga': instance.relatedManga,
      'recommendations': instance.recommendations.map((Recommendation e) => e.toJson()).toList(),
      'studios': instance.studios.map((Genre e) => e.toJson()).toList(),
